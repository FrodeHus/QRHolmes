      ...
      <section className="plain-panel">
        ...
        <div className="privacy-list">
          <article>
            ...
            <p>Decoding and payload inspection happen locally in your browser.</p>
          </article>
          <article>
        ...
        <div className="privacy-note">Opening a link contacts the destination. Copying does not make a network request.</div>
